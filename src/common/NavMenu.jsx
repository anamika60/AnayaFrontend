    ...
    <NavigationMenu>
      <NavigationMenuList className="px-12 flex gap-5 flex-row items-center">
            ...
            <div className="flex p-5 w-[600px]">
              <ul className="w-1/3">
                {Object.keys(categories).map((category) => (
                  <li key={category}>
                    <a  href={categories[category][0].href}
            ...
            <div className=" flex p-5 w-[600px]">
              <ul className="w-1/3">
                {Object.keys(marketingCategories).map((category) => (
                  <li key={category}>
                   <a  href={marketingCategories[category][0].href}
            ...
            <div className="flex p-5 w-[600px]">
              <ul className="w-1/3">
                {Object.keys(educationCategories).map((category) => (
                  <li key={category}>
                 <a  href={educationCategories[category][0].href}
        ...
        <NavigationMenuItem>
          ...
          <Button  variant="link" className="text-base">Contact Us</Button> 
          </Link>
        </NavigationMenuItem>
      </NavigationMenuList>
    </NavigationMenu>
